...
const VOCAB = [
  ...
  { ch:2, en:'major / specialty', ja:'せんこう', kana:'せんこう' },
  ...
  // Ch 3 verbs not yet covered
  { ch:3, en:'to go', ja:'いきます', kana:'いきます' },
  { ch:3, en:'to come', ja:'きます', kana:'きます' },
  { ch:3, en:'to do', ja:'します', kana:'します' },
  { ch:3, en:'to return / go home', ja:'かえります', kana:'かえります' },
  { ch:3, en:'to enter (bath)', ja:'はいります', kana:'はいります' },
  { ch:3, en:'to take a shower', ja:'あびます', kana:'あびます' },
  ...
  // Ch 6 verbs
  { ch:6, en:'to meet', ja:'会います', kana:'あいます', kanjiNote:'会 = meet' },
  { ch:6, en:'to play / have fun', ja:'あそびます', kana:'あそびます' },
  { ch:6, en:'to walk', ja:'歩きます', kana:'あるきます', kanjiNote:'歩 = walk' },
  { ch:6, en:'to say', ja:'言います', kana:'いいます', kanjiNote:'言 = say' },
  { ch:6, en:'to swim', ja:'およぎます', kana:'およぎます' },
  { ch:6, en:'to wait', ja:'まちます', kana:'まちます' },
  { ch:6, en:'to call / invite (someone)', ja:'よびます', kana:'よびます' },
  { ch:6, en:'to make (a phone call)', ja:'かけます', kana:'かけます' },
  { ch:6, en:'to go out', ja:'でかけます', kana:'でかけます' },
  { ch:6, en:'to ask / listen to', ja:'ききます', kana:'ききます' },
  // Ch 6 i-adjectives
